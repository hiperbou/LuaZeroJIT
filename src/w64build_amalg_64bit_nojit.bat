@rem Script to build LuaJIT (amalgamated, 64-bit, JIT disabled) with w64devkit (MinGW/GCC).
...
call w64clean.bat
mingw32-make amalg HOST_MSYS=mingw XCFLAGS="-DLUAJIT_DISABLE_GC64 -DLUAJIT_DISABLE_JIT"
