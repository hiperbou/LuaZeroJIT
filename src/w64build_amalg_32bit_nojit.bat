@rem Script to build LuaJIT (amalgamated, JIT disabled) with w64devkit (MinGW/GCC).
...
mingw32-make clean
mingw32-make amalg HOST_MSYS=mingw CC="gcc -m32 -g" XCFLAGS="-DLUAJIT_DISABLE_GC64 -DLUAJIT_DISABLE_JIT -g"
